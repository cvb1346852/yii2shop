    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=Yii::$app->params['backUp'].$goods->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=Yii::$app->params['backUp'].$goods->logo?>" alt="" width="350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($goods->img as $k=>$img): ?>
                            <li class="<?=$k==0?'cur':''?>">
                                <a class="<?=$k==0?'zoomThumbActive':''?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=Yii::$app->params['backUp'].$img->photo?>',largeimage: '<?=Yii::$app->params['backUp'].$img->photo?>'}"><img src="<?=Yii::$app->params['backUp'].$img->photo?>"></a>
                            </li>
                            <?php endforeach;?>
                            <!--<li>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="add-cart.html" method="post" class="choose">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品编号：</span><?=$goods->sn?></li>
                            <li><span>品牌：</span><?=$goods->brandName->name?></li>
                    ...
                    <div class="desc mt10" id="content">
