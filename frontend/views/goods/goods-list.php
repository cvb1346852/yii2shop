    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="filter mt10">
            ...
            <div class="filter_wrap">
                <dl>
                    <dt>品牌：</dt>
                    <dd class="cur"><?=\yii\helpers\Html::a('不限',['goods/goods-list'])?></dd>
                    <?php foreach ($brands as $brand): ?>
                    <dd><?=\yii\helpers\Html::a($brand->name,['goods/goods-list','brand_id'=>$brand->id])?></dd>
                    <?php endforeach;?>
                </dl>
                ...
                <?php if($goodses != null) {
                    foreach ($goodses as $goods):?>
                        <li>
                            <dl>
                                <dt>
                                    <a href="goods-content.html?id=<?= $goods->id ?>"><?= \yii\bootstrap\Html::img('http://admin.yiishop.com' . $goods->logo) ?></a>
                                </dt>
                                <dd><?=\yii\helpers\Html::a($goods->name,['goods/goods-content','id'=>$goods->id])?>
                                </dt>
                                <dd><strong><?= $goods->shop_price ?></strong>
                                </dt>
